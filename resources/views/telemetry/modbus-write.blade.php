...
@section('title', 'Modbus Write History')

@section('content')
<div class="container mt-4">
    <div class="row mb-3">
        <div class="col-md-8">
            <h2>Modbus Write History</h2>
        </div>
        <div class="col-md-4">
    ...
    @else
        <div class="alert alert-info" role="alert">
            <strong>No modbus write data found.</strong>
            @if(request('collector_id'))
                Try a different Collector ID or clear the filter.
            @else
                Start collecting modbus write data to see results here.
            @endif
        </div>
    @endif
</div>
